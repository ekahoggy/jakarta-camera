...
class CreateSnapTokenService extends Midtrans
{
	...
	public function getSnapToken()
	{
		$params = [
			 ...
			 */
			'transaction_details' => [
				'order_id' => $this->donations->no_donation,
				'gross_amount' => $this->donations->total_donation,
			],
			/**
			...
			'customer_details' => [
				...
				'name' => $this->donations->name,
				'email' => $this->donations->email,
				'phone' => $this->donations->phone_code . $this->donations->phone_number,
			]
		];
