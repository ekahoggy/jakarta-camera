    ...
    <div class="section-body">
        <div class="card">
            <div class="card-header justify-content-between d-flex">
                <h3>
                    Tambah User<br>
                    <span class="sub-text-header">Tambahkan pengguna baru dan tambahkan mereka ke situs ini.</span>
                </h3>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="drop-zone" id="drop-zone" {{-- onclick="document.getElementById('image-input').click()" --}}
                                            ...
                                            {{-- <input type="file" name="picture" id="image-input" accept="image/*" onchange="showPreview(event)" class="hidden" /> --}}
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input class="form-control form-control-sm" id="name" name="name"
                                    value="{{ old('name') }}" rows="5" placeholder="Masukkan Nama Lengkap" required>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input class="form-control form-control-sm" id="username" name="username"
                                    value="{{ old('username') }}" rows="5" placeholder="Masukkan Username" required>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="phone_number" class="form-control form-control-sm" id="phone_number"
                                    name="phone_number" value="{{ old('phone_number') }}" rows="5"
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="address" class="form-control form-control-sm" id="address" name="address"
                                    value="{{ old('address') }}" rows="5" placeholder="Masukkan Alamat Lengkap"
                                    required>
                            </div>
                        </div>
                        <div class="col-md-12">
