...
@section('content')
    <div class="section-body">
        <div class="card">
            ...
            <div class="card-body">
                <form method="post" action="{{ route('testimoni.update', $model->id) }}" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col-6"></div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="drop-zone @if ($model->photo != null) hidden @endif"
                                            id="drop-zone" style="max-width: 350px !important;" data-target="#exampleModal"
                                            data-toggle="modal">
                        ...
                        <div class="col-md-12 ">
                            <div class="form-group">
                                ...
                                <input class="form-control form-control-sm" id="name" name="name"
                                    value="{{ $model->name }}" rows="5" placeholder="Masukkan Nama" required>
                            </div>
                        </div>
                        <div class="col-md-12 bhs-indonesia">
                            <div class="form-group">
                                ...
                                <textarea class="form-control form-control-sm" name="testimoni" id="testimoni" rows="5"
                                    placeholder="Masukkan Testimoni">{{ $model->testimoni }}</textarea>
                            </div>
                        </div>
                        <div class="col-md-12 bhs-english hidden">
                            <div class="form-group">
                                <label for="testimoni_en">Testimoni EN</label>
                                <textarea class="form-control form-control-sm" name="testimoni_en" id="testimoni_en" rows="5"
                                    placeholder="Masukkan Testimoni">{{ $model->testimoni_en }}</textarea>
                            </div>
                        </div>
                    </div>
