            ...
            <div class="card-header justify-content-between d-flex">
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0">
                        <li class="breadcrumb-item"><a href="/kegiatan">Event</a></li>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input class="form-control form-control-sm" id="place" name="place"
                                    value="{{ old('place') }}" rows="5" placeholder="Masukkan Lokasi Gereja" required>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input class="form-control form-control-sm" id="city" name="city"
                                    value="{{ old('city') }}" rows="5" placeholder="Masukkan Alamat Gereja" required>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input class="form-control form-control-sm" id="event" name="event"
                                    value="{{ old('event') }}" rows="5" placeholder="Masukkan Nama Gereja" required>
                            </div>
                        </div>
                        ...
                        <div class="col-md-12 bhs-english hidden">
                            <div class="form-group">
                                ...
                                <div class="col-sm-12 p-0">
                                    <textarea class="summernote" name="intro_en"></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
