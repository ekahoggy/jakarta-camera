...
@section('content')
    <div class="section-body">
        <div class="card">
            ...
            <div class="card-body">
                <form method="post" action="{{ route('subscription.update', $model->id) }}" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input class="form-control form-control-sm" id="first_name" name="first_name"
                                    value="{{ $model->first_name }}" rows="5" placeholder="Masukkan First Name" required>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input class="form-control form-control-sm" id="last_name" name="last_name"
                                    value="{{ $model->last_name }}" rows="5" placeholder="Masukkan Last Name" required>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
